...
public class Polycube2 implements Serializable {
    ...
    public Polycube2(Polycube2 polycube, Point newCubePoint) {
        this(polycube);
        this.addCube(newCubePoint);
        this.shrinkGrid();
    }

    private Polycube2(Polycube2 polycube) {
    ...
    public Polycube2 clone() {
        return new Polycube2(this);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof Polycube2 other)) {
            return false;
        }
