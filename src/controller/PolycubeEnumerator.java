...
public class PolycubeEnumerator {
    ...
    public static Polycube findCanonicalRotation(Polycube polycube) {
        Optional<Polycube> canonicalPolycube = IntStream.range(0, 4)
                .boxed()
        ...
        return canonicalPolycube.orElse(polycube);
    }
}
